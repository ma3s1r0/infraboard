...
<html>
  ...
  <head>
    ...
    <!-- Editor -->
    <link rel="stylesheet" href="/res/css/editor.css" type="text/css" charset="utf-8"/>
    <script src="/res/js/editor_loader.js" type="text/javascript" charset="utf-8"></script>
  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <jsp:include page="../include/sidebar.jsp">
	  	<jsp:param name="pageName" value="blank"/>
	  </jsp:include>  
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Content -->
          <form name="tx_editor_form" id="tx_editor_form" action="/infraboard/board/post" method="post" accept-charset="utf-8">
          	<input type="text" id="title" name="title" class="form-control" style="width:100%;float:left; margin-bottom:10px" placeholder="제목"/>
			<!-- 에디터 컨테이너 시작 -->
			<div id="tx_trex_container" class="tx-editor-container">
							...
							<div id="tx_richtextbox_menu" class="tx-richtextbox-menu tx-menu">
								...
								<div class="tx-menu-footer">
									<img class="tx-menu-confirm"
										 src="/res/images/icon/editor/btn_confirm.gif?rv=1.0.1" alt=""/>
									<img class="tx-menu-cancel" hspace="3"
										 src="/res/images/icon/editor/btn_cancel.gif?rv=1.0.1" alt=""/>
								</div>
							</div>
						</li>
						<li class="tx-list">
				...
				<div id="tx_canvas" class="tx-canvas">
					<div id="tx_loading" class="tx-loading"><div><img src="/res/images/icon/editor/loading2.png" width="113" height="21" align="absmiddle"/></div></div>
				...
				<div id="tx_resizer" class="tx-resize-bar">
					...
					<img id="tx_resize_holder" src="/res/images/icon/editor/skin/01/btn_drag01.gif" width="58" height="12" unselectable="on" alt="" />
				</div>
				<div class="tx-side-bi" id="tx_side_bi">
					<div style="text-align: right;">
						<input type="button" value="저장" class="btn btn-primary" onClick="btnAction('1');"/>
						<input type="button" value="취소" class="btn btn-secondary" onClick="btnAction('2');"/>
						<img hspace="4" height="14" width="78" align="absmiddle" src="/res/images/icon/editor/editor_bi.png" style="display:none;"/>
					</div>
				</div>
				<!-- 편집영역 끝 -->
				<!-- 첨부박스 시작 -->
				...
				<div id="tx_attach_div" class="tx-attach-div">
					...
					<div id="tx_attach_box" class="tx-attach-box">
						<div class="tx-attach-box-inner">
							<div id="tx_attach_preview" class="tx-attach-preview"><p></p><img src="/res/images/icon/editor/pn_preview.gif" width="147" height="108" unselectable="on"/></div>
	...
	<script type="text/javascript">
		var config = {
			...
			txIconPath: "/res/images/icon/editor/", /*에디터에 사용되는 이미지 디렉터리, 필요에 따라 수정한다. */
			txDecoPath: "/res/images/deco/contents/", /*본문에 사용되는 이미지 디렉터리, 서비스에서 사용할 때는 완성된 컨텐츠로 배포되기 위해 절대경로로 수정한다. */
			canvas: {
	            exitEditor:{
	                /*
			...
			attacher: { 
				image: { 
						...
						popPageUrl:'/infraboard/board/image_attatch' //팝업창 주소
					},
					// 파일첨부 관련 추가 config
				file:{
				        features:{left:250,top:65,width:400,height:190,scrollbars:0}, // 팝업창 사이즈
				        popPageUrl:'/infraboard/board/file_attatch' // 팝업창 주소
				    }
				},
