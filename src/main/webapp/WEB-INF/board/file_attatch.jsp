...
<script src="/res/js/popup.js" type="text/javascript" charset="utf-8"></script>
<link rel="stylesheet" href="/res/css/popup.css" type="text/css"  charset="utf-8"/>
<style> /* css */
.header {
...
// <![CDATA[
	$(document).ready(function (){
		...
		$('.submit a').on('click', function () {
		    ...
		    form.ajaxSubmit({
		        type: 'POST',
		        url: '/infraboard/board/singleUploadFileAjax',
