  ...
  <body id="page-top">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="/infraboard/home">Dashboard</a>
            </li>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i>
              	게시판
              	<input type="button" class="btn btn-primary" style="float:right;" value="글쓰기" onClick="board_write();"/>
             </div>
            <div class="card-body">
	...
	<script type="text/javascript">
		function board_write(){
			location.href="/infraboard/board/write";
		}
	</script>
  </body>
